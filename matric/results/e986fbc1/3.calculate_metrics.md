...
```
    ...
    ## input_profile_file: ./results/e986fbc1/profiles.parquet
    ## input_collatedindex_file: ./results/e986fbc1/collatedindex.parquet
    ## output_collatedsim_file: ./results/e986fbc1/collatedsim.parquet
    ## output_metrics_file_prefix: ./results/e986fbc1/metrics
