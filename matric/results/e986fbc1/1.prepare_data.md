...
```
    ...
    ## output_profile_file: ./results/e986fbc1/profiles.parquet
...
```
    ...
    ## Warning in left_join(., split_mapper_full, by = split_single): Each row in `x` is expected to match at most 1 row in `y`.
