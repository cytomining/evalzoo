...
```
    ...
    ## input_metrics_file_prefix: results/34513126/metrics
...
```
    ...
    ##   output_profile_file: results/34513126/profiles.parquet
    ...
    ##   - Metadata_pert_name
    ## calculate_index:
    ##   input_profile_file: results/34513126/profiles.parquet
    ##   output_index_file: results/34513126/index.parquet
    ##   output_collatedindex_file: results/34513126/collatedindex.parquet
    ##   sim_params:
    ##     drop_group:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/34513126/profiles.parquet
    ##   input_collatedindex_file: results/34513126/collatedindex.parquet
    ##   output_collatedsim_file: results/34513126/collatedsim.parquet
    ##   output_metrics_file_prefix: results/34513126/metrics
