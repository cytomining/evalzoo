...
```
    ...
    ## input_metrics_file_prefix: ./results/fdb4792c/metrics
...
```
    ...
    ##   output_profile_file: ./results/fdb4792c/profiles.parquet
    ...
    ##   split_by_column: ~
    ## calculate_index:
    ##   input_profile_file: ./results/fdb4792c/profiles.parquet
    ##   output_index_file: ./results/fdb4792c/index.parquet
    ##   output_collatedindex_file: ./results/fdb4792c/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: ./results/fdb4792c/profiles.parquet
    ##   input_collatedindex_file: ./results/fdb4792c/collatedindex.parquet
    ##   output_collatedsim_file: ./results/fdb4792c/collatedsim.parquet
    ##   output_metrics_file_prefix: ./results/fdb4792c/metrics
