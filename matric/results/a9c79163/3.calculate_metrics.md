...
```
    ...
    ## input_profile_file: ./results/a9c79163/profiles.parquet
    ## input_collatedindex_file: ./results/a9c79163/collatedindex.parquet
    ## output_collatedsim_file: ./results/a9c79163/collatedsim.parquet
    ## output_metrics_file_prefix: ./results/a9c79163/metrics
