...
```
    ...
    ## input_profile_files:
    ## - tag: ''
    ##   filename: /Users/shsingh/work/projects/grit-benchmark/1.calculate-metrics/cell-health/data//cell_health_merged_feature_select.csv.gz
    ## output_profile_file: ./results/3779c75e/profiles.parquet
...
| tag | filename                                                                                                                   |
|:----|:---------------------------------------------------------------------------------------------------------------------------|
|     | /Users/shsingh/work/projects/grit-benchmark/1.calculate-metrics/cell-health/data//cell_health_merged_feature_select.csv.gz |
...
```
    ...
    ## dbl (396): Metadata_WellCol, Cells_AreaShape_Compactness, Cells_AreaShape_Extent, Cells_AreaShape_Zernike_0_0, Cells_AreaShape_Zer...
    ## 
...
```
    ...
    ## Joining with `by = join_by(Metadata_gene_name)`
