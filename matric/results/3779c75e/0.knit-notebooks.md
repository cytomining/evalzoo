...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): './results/3779c75e' already exists
...
```
    ...
    ##     - Metadata_gene_name
    ##     - Metadata_reference_or_other
    ##     any_different_cols_group: Metadata_cell_line
    ##     annotation_cols:
    ##     - Metadata_cell_line
    ##     - Metadata_pert_name
    ##     - Metadata_gene_name
...
```
    ...
    ## 
    ## Output created: results/3779c75e/1.prepare_data.md
    ...
    ## 
    ## Output created: results/3779c75e/2.calculate_index.md
...
```
    ...
    ## 
    ## Output created: results/3779c75e/3.calculate_metrics.md
...
```
    ...
    ## 
    ## Output created: results/3779c75e/5.inspect_metrics.md
