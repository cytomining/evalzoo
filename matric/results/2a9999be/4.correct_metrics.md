...
```
    ...
    ##   output_profile_file: results/2a9999be/profiles.parquet
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: results/2a9999be/profiles.parquet
    ##   output_index_file: results/2a9999be/index.parquet
    ##   output_collatedindex_file: results/2a9999be/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/2a9999be/profiles.parquet
    ##   input_collatedindex_file: results/2a9999be/collatedindex.parquet
    ##   output_collatedsim_file: results/2a9999be/collatedsim.parquet
    ##   output_metrics_file_prefix: results/2a9999be/metrics
