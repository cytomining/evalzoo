...
```
    ...
    ## input_profile_file: ./results/66c5d0e6/profiles.parquet
    ## output_index_file: ./results/66c5d0e6/index.parquet
    ## output_collatedindex_file: ./results/66c5d0e6/collatedindex.parquet
    ## sim_params:
    ##   reference:
