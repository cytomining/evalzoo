...
```
    ...
    ## input_metrics_file_prefix: ./results/ec6a5e7a/metrics
...
```
    ...
    ##   output_profile_file: ./results/ec6a5e7a/profiles.parquet
    ...
    ##     compact_splits: yes
    ## calculate_index:
    ##   input_profile_file: ./results/ec6a5e7a/profiles.parquet
    ##   output_index_file: ./results/ec6a5e7a/index.parquet
    ##   output_collatedindex_file: ./results/ec6a5e7a/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: ./results/ec6a5e7a/profiles.parquet
    ##   input_collatedindex_file: ./results/ec6a5e7a/collatedindex.parquet
    ##   output_collatedsim_file: ./results/ec6a5e7a/collatedsim.parquet
    ##   output_metrics_file_prefix: ./results/ec6a5e7a/metrics
...
|   3 | 246 |                       0.0925400 |                 0.0000000 |
|   3 | 251 |                       0.1013950 |                 0.0000000 |
|   4 | 246 |                       0.1001382 |                 0.2500000 |
|   4 | 251 |                       0.0952815 |                 0.2500000 |
|   5 | 246 |                       0.1107947 |                 0.2000000 |
|   5 | 251 |                       0.0993897 |                 0.2000000 |
|   6 | 246 |                       0.1084533 |                 0.1666667 |
|   6 | 251 |                       0.1065133 |                 0.1666667 |
|   7 | 251 |                       0.1081808 |                 0.1428571 |
|   8 | 246 |                       0.1182332 |                 0.1250000 |
|   8 | 251 |                       0.1141670 |                 0.1250000 |
|   9 | 251 |                       0.1182354 |                 0.1111111 |
