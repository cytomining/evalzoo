...
```
    ...
    ## input_metrics_file_prefix: results/b958b1af/metrics
...
```
    ...
    ##   output_profile_file: results/b958b1af/profiles.parquet
    ...
    ##   output_index_file: results/b958b1af/index.parquet
    ##   output_collatedindex_file: results/b958b1af/collatedindex.parquet
    ##   sim_params:
    ##     reference:
