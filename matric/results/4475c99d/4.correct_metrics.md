...
```
    ...
    ## input_metrics_file_prefix: results/4475c99d/metrics
...
```
    ...
    ##   output_profile_file: results/4475c99d/profiles.parquet
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/4475c99d/profiles.parquet
    ##   input_collatedindex_file: results/4475c99d/collatedindex.parquet
    ##   output_collatedsim_file: results/4475c99d/collatedsim.parquet
    ##   output_metrics_file_prefix: results/4475c99d/metrics
