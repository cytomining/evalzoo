...
```
    ...
    ## input_metrics_file_prefix: ./results/85d6508d/metrics
    ## background_type: ref
    ## random_seed: 42
...
```
    ...
    ##   output_profile_file: ./results/85d6508d/profiles.parquet
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: ./results/85d6508d/profiles.parquet
    ##   output_index_file: ./results/85d6508d/index.parquet
    ##   output_collatedindex_file: ./results/85d6508d/collatedindex.parquet
    ##   sim_params:
    ##     drop_group:
    ...
    ## calculate_metrics:
    ##   input_profile_file: ./results/85d6508d/profiles.parquet
    ##   input_collatedindex_file: ./results/85d6508d/collatedindex.parquet
    ##   output_collatedsim_file: ./results/85d6508d/collatedsim.parquet
    ##   output_metrics_file_prefix: ./results/85d6508d/metrics
