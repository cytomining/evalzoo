...
```
    ...
    ## input_metrics_file_prefix: results/5c25c164/metrics
...
```
    ...
    ##   output_profile_file: results/5c25c164/profiles.parquet
    ...
    ##   compact_splits: yes
    ## calculate_index:
    ##   input_profile_file: results/5c25c164/profiles.parquet
    ##   output_index_file: results/5c25c164/index.parquet
    ##   output_collatedindex_file: results/5c25c164/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/5c25c164/profiles.parquet
    ##   input_collatedindex_file: results/5c25c164/collatedindex.parquet
    ##   output_collatedsim_file: results/5c25c164/collatedsim.parquet
    ##   output_metrics_file_prefix: results/5c25c164/metrics
