...
![](5.inspect_metrics_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
![](5.inspect_metrics_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
![](5.inspect_metrics_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
...
p <- 
  level_1_metrics_null_adjusted %>%
  ggplot(aes(
    .data[[glue("sim_retrieval_average_precision_{type}_i_mean_i")]], 
    .data[[glue("sim_retrieval_average_precision_{type}_i_nlog10pvalue_mean_i")]],
    label = .data[[label_name]])) +
  geom_point() +
  ggrepel::geom_text_repel(
    data = level_1_metrics_null_adjusted %>% 
      filter(.data[[glue("sim_retrieval_average_precision_{type}_i_nlog10pvalue_mean_i")]] > 2 * -log10(significance_threshold)),
    max.overlaps = 100) +
  geom_hline(yintercept = 2 * -log10(significance_threshold)) +
  theme_bw() + 
  labs(caption = "Jittered version of the points are in red")
...
![](5.inspect_metrics_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->
