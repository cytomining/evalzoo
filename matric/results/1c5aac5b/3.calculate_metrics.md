...
```
    ...
    ## input_collatedindex_file: ./results/1c5aac5b/collatedindex.parquet
    ## output_collatedsim_file: ./results/1c5aac5b/collatedsim.parquet
    ## output_metrics_file_prefix: ./results/1c5aac5b/metrics
