...
```
    ...
    ## input_metrics_file_prefix: ./results/af78d611/metrics
...
```
    ...
    ##   output_profile_file: ./results/af78d611/profiles.parquet
    ...
    ##   split_by_column: ~
    ## calculate_index:
    ##   input_profile_file: ./results/af78d611/profiles.parquet
    ##   output_index_file: ./results/af78d611/index.parquet
    ##   output_collatedindex_file: ./results/af78d611/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: ./results/af78d611/profiles.parquet
    ##   input_collatedindex_file: ./results/af78d611/collatedindex.parquet
    ##   output_collatedsim_file: ./results/af78d611/collatedsim.parquet
    ##   output_metrics_file_prefix: ./results/af78d611/metrics
