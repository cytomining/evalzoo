...
```
    ...
    ## input_metrics_file_prefix: ./results/1fc3882d/metrics
...
```
    ...
    ##   output_profile_file: ./results/1fc3882d/profiles.parquet
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: ./results/1fc3882d/profiles.parquet
    ##   output_index_file: ./results/1fc3882d/index.parquet
    ##   output_collatedindex_file: ./results/1fc3882d/collatedindex.parquet
    ##   sim_params:
    ##     drop_group:
    ...
    ## calculate_metrics:
    ##   input_profile_file: ./results/1fc3882d/profiles.parquet
    ##   input_collatedindex_file: ./results/1fc3882d/collatedindex.parquet
    ##   output_collatedsim_file: ./results/1fc3882d/collatedsim.parquet
    ##   output_metrics_file_prefix: ./results/1fc3882d/metrics
