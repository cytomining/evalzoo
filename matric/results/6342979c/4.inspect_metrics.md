...
```
    ...
    ## input_metrics_file_prefix: results/6342979c/metrics
...
```
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/6342979c/profiles.parquet
    ##   input_collatedindex_file: results/6342979c/collatedindex.parquet
    ##   output_collatedsim_file: results/6342979c/collatedsim.parquet
    ##   output_metrics_file_prefix: results/6342979c/metrics
