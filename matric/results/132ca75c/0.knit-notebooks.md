...
```
    ...
    ## Warning in dir.create(results_dir, showWarnings = TRUE, recursive = TRUE): './results/132ca75c' already exists
...
```
    ...
    ## 
    ## Output created: results/132ca75c/1.prepare_data.md
    ...
    ## 
    ## Output created: results/132ca75c/2.calculate_index.md
...
```
    ...
    ## 
    ## Output created: results/132ca75c/3.calculate_metrics.md
...
```
    ...
    ## 
    ## Output created: results/132ca75c/4.correct_metrics.md
...
```
    ...
    ## 
    ## Output created: results/132ca75c/5.inspect_metrics.md
