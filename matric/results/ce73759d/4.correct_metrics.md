...
```
    ...
    ## input_metrics_file_prefix: results/ce73759d/metrics
...
```
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: results/ce73759d/profiles.parquet
    ##   output_index_file: results/ce73759d/index.parquet
    ##   output_collatedindex_file: results/ce73759d/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/ce73759d/profiles.parquet
    ##   input_collatedindex_file: results/ce73759d/collatedindex.parquet
    ##   output_collatedsim_file: results/ce73759d/collatedsim.parquet
    ##   output_metrics_file_prefix: results/ce73759d/metrics
