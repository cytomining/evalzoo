...
```
    ...
    ## input_metrics_file_prefix: ./results/6d0fe6c5/metrics
    ## background_type: ref
    ## random_seed: 42
...
```
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: ./results/6d0fe6c5/profiles.parquet
    ##   output_index_file: ./results/6d0fe6c5/index.parquet
    ##   output_collatedindex_file: ./results/6d0fe6c5/collatedindex.parquet
    ##   sim_params:
    ##     drop_group:
    ...
    ## calculate_metrics:
    ##   input_profile_file: ./results/6d0fe6c5/profiles.parquet
    ##   input_collatedindex_file: ./results/6d0fe6c5/collatedindex.parquet
    ##   output_collatedsim_file: ./results/6d0fe6c5/collatedsim.parquet
    ##   output_metrics_file_prefix: ./results/6d0fe6c5/metrics
