...
```
    ...
    ## input_metrics_file_prefix: results/d9cc15a8/metrics
...
```
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: results/d9cc15a8/profiles.parquet
    ##   output_index_file: results/d9cc15a8/index.parquet
    ##   output_collatedindex_file: results/d9cc15a8/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/d9cc15a8/profiles.parquet
    ##   input_collatedindex_file: results/d9cc15a8/collatedindex.parquet
    ##   output_collatedsim_file: results/d9cc15a8/collatedsim.parquet
    ##   output_metrics_file_prefix: results/d9cc15a8/metrics
