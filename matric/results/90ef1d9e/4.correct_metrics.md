...
```
    ...
    ##   output_profile_file: results/90ef1d9e/profiles.parquet
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: results/90ef1d9e/profiles.parquet
    ##   output_index_file: results/90ef1d9e/index.parquet
    ##   output_collatedindex_file: results/90ef1d9e/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/90ef1d9e/profiles.parquet
    ##   input_collatedindex_file: results/90ef1d9e/collatedindex.parquet
    ##   output_collatedsim_file: results/90ef1d9e/collatedsim.parquet
    ##   output_metrics_file_prefix: results/90ef1d9e/metrics
