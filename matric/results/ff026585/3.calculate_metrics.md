...
```
    ...
    ## input_profile_file: ./results/ff026585/profiles.parquet
    ## input_collatedindex_file: ./results/ff026585/collatedindex.parquet
    ## output_collatedsim_file: ./results/ff026585/collatedsim.parquet
    ## output_metrics_file_prefix: ./results/ff026585/metrics
