...
```
    ...
    ## input_metrics_file_prefix: results/c898905c/metrics
...
```
    ...
    ##     threshold: 0
    ## calculate_index:
    ##   input_profile_file: results/c898905c/profiles.parquet
    ##   output_index_file: results/c898905c/index.parquet
    ##   output_collatedindex_file: results/c898905c/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/c898905c/profiles.parquet
    ##   input_collatedindex_file: results/c898905c/collatedindex.parquet
    ##   output_collatedsim_file: results/c898905c/collatedsim.parquet
    ##   output_metrics_file_prefix: results/c898905c/metrics
