...
```
    ...
    ## Git commit of https://github.com/broadinstitute/grit-benchmark/raw/main/1.calculate-metrics/cell-health/data/ = e528c806238527a44390c10bab88ef358453e888
    ## Git remote of https://github.com/broadinstitute/grit-benchmark/raw/main/1.calculate-metrics/cell-health/data/ = origin   git@github.com:shntnu/evalzoo.git (fetch)
    ## Git remote of https://github.com/broadinstitute/grit-benchmark/raw/main/1.calculate-metrics/cell-health/data/ = origin   git@github.com:shntnu/evalzoo.git (push)
    ## Git remote of https://github.com/broadinstitute/grit-benchmark/raw/main/1.calculate-metrics/cell-health/data/ = upstream git@github.com:cytomining/evalzoo.git (fetch)
    ## Git remote of https://github.com/broadinstitute/grit-benchmark/raw/main/1.calculate-metrics/cell-health/data/ = upstream git@github.com:cytomining/evalzoo.git (push)
...
```
    ...
    ## dbl (396): Metadata_WellCol, Cells_AreaShape_Compactness, Cells_AreaShape_Extent, Cells_AreaShape_Zernike_0_0, Cells_AreaShape_Zernike_1_1, Cells_Ar...
