...
```
    ...
    ## input_metrics_file_prefix: results/2b38fc8e/metrics
...
```
    ...
    ##   output_profile_file: results/2b38fc8e/profiles.parquet
    ...
    ##   compact_splits: no
    ## calculate_index:
    ##   input_profile_file: results/2b38fc8e/profiles.parquet
    ##   output_index_file: results/2b38fc8e/index.parquet
    ##   output_collatedindex_file: results/2b38fc8e/collatedindex.parquet
    ##   sim_params:
    ##     reference:
    ...
    ## calculate_metrics:
    ##   input_profile_file: results/2b38fc8e/profiles.parquet
    ##   input_collatedindex_file: results/2b38fc8e/collatedindex.parquet
    ##   output_collatedsim_file: results/2b38fc8e/collatedsim.parquet
    ##   output_metrics_file_prefix: results/2b38fc8e/metrics
