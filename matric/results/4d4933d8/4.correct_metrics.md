...
```
    ...
    ## input_metrics_file_prefix: ./results/4d4933d8/metrics
...
```
    ...
    ##   output_index_file: ./results/4d4933d8/index.parquet
    ##   output_collatedindex_file: ./results/4d4933d8/collatedindex.parquet
    ##   sim_params:
    ##     reference:
