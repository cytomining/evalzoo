...
if (file.exists(output_profile_file) &
  ...
  render_notebook(input = "1.prepare_data.Rmd",
  ...
  render_notebook(input = "2.calculate_index.Rmd",
                  output_dir = results_dir,
                  params = parameters)
...
if (file.exists(output_collatedsim_file) &
  ...
  render_notebook(input = "3.calculate_metrics.Rmd",
                  output_dir = results_dir,
                  params = parameters)
...
parameters <-
  with(params$experiment,
       list(input_metrics_file_prefix = input_metrics_file_prefix))

render_notebook(input = "4.inspect_metrics.Rmd",
                output_dir = results_dir,
                params = parameters)
```
